...
$stmt = $pdo->prepare('UPDATE travel_table SET name = :name, place=:place,date=:date,address=:address,score=:score,impression=:impression, fname=:fname WHERE id = :id');
...
$stmt->bindValue(':score', $address, PDO::PARAM_INT);  //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':impression', $impression, PDO::PARAM_INT);  //Integer（数値の場合 PDO::PARAM_INT)
$stmt->bindValue(':fname', $fname, PDO::PARAM_INT);  //Integer（数値の場合 PDO::PARAM_INT)
